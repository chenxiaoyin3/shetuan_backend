...
//
//@Entity
//@Table(name="hy_advance_purchase")
...
//
//  public AdvancePurchase(Long id)
//  {
//    this.id = id;
//  }
//
//  public AdvancePurchase(Long id, String advanceSerialNum, Long purchaseId, Double advanceAmount, String payeeName, String payeeAccount, String payerName, String payerAccount, String applicant, Date applicationTime, Integer status, String reviewer, Date reviewTime, String operator, Date payTime)
//  {
//    this.id = id;
