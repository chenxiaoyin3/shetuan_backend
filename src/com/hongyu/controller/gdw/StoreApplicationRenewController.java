...
@Controller
@RequestMapping("/admin/storeApplicationRenew/")
public class StoreApplicationRenewController {
	...
	public Json list(Pageable pageable, Integer status, String storeName, String contact, String phone,
		...
		try {
			...
			filters.add(Filter.eq("type", 2));// 2续签申请
	...
	public Json audit(Long id, String comment, String contract, BigDecimal managementFee,
