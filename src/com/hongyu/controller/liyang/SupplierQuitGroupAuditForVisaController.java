 ...
 * 供应商退签证审核
 * @author liyang
 * @version 2019年5月28日 下午5:39:04
 */
@Controller
@RequestMapping("/admin/gysQuitGroupAuditForVisa/")
public class SupplierQuitGroupAuditForVisaController {
	...
	public Json storeCancelVisaAudit(Long id, String comment, Integer auditStatus, HttpSession session) {
		...
		try {
			...
			if (auditStatus.equals(1)) { // 如果审核通过
				...
				// add by wj 2019/7/20  签证退订驳回短信提示
