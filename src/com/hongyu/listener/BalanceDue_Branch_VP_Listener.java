...
public class BalanceDue_Branch_VP_Listener implements TaskListener {
	...
	public void notify(DelegateTask delegateTask) {
		...
		Department department2 = DepartmentService.find(branchId);
		
		List<String> userIds = new ArrayList<>();
		for (HyAdmin admin : department2.getHyAdmins()) {
