...
public class Configure {
    ...
    // 商户号，格式如A0000001
    private static String appid = "Q0001522";

    // 商户私有密钥，该密钥需要严格保密，只能出现在后台服务端代码中，不能放在可能被用户查看到的地方，如html、js代码等
    // 在发送报文给收付直通车时，会使用该密钥进行签名
    // 在收到收付直通车返回的报文时，将使用该密钥进行验签
    private static String commKey = "B24588EA67CA4B409D57F23CD4EBB5A2";

    // 商户客户端证书路径，该证书需要严格保密，支持classpath路径或绝对路径
    // 在发送报文给收付直通车时，会使用该密钥进行签名（RSA算法方式）
    private static String mrch_cert = "com/hongyu/source/appsvr_client.pfx";
//    private static String mrch_cert = "source/appsvr_client.pfx";
    // 以下证书参数一般为默认值，无需更改
    private static String mrch_cert_pwd = "123456";
    // 收付直通车服务器证书，RSA算法验签使用
    private static String epay_cert_test = "com/hongyu/source/appsvr_server_test.crt";
    private static String epay_cert_prod = "com/hongyu/source/appsvr_server_prod.crt";
    ...
    public static String httpsRequestClassName = "com.hongyu.util.industrialBankUtil.HttpsPostRequest";
...
//    public static final String GP_DEV_API = "https://3gtest.cib.com.cn:37031/acquire/cashier.do";
    public static final String GP_DEV_API = "https://www.xingyeguanjia.com:37031/acquire/cashier.do";
